...
|-------|-------------|--------|------|----------|--------|
| #2 | Post-processing v2 | +0.5~1.2 | ✅ Low | 🔥 Day 1 | 📋 Planned |
| #3 | Learning Rate 2e-5 | +1~2 | ✅ Low | Day 2 | 📋 Planned |
...
- [ ] **Day 1 (오늘)**: Exp #2 (후처리 v2) → 47.5~48.2 목표 🔥
- [ ] **Day 2**: Exp #3 (LR 2e-5) → 48.5~49.5 목표
- [ ] **Day 3**: Exp #4 (LR 3e-5) → 49.5~50.5 목표
- [ ] **Day 4**: Exp #5 (LR 5e-5 or Time Token) → 50~51 목표
