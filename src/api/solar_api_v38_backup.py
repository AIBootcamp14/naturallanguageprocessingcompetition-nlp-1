...
4. 이름 우선순위 강제 적용
5. 조사 처리 완전 수정
6. 고립된 조사 제거 (v3.8 신규) - "가 Brian" → "Brian"
"""
...
class SolarAPI:
    ...
    def _validate_and_fix_summary(self, text: str, dialogue: str) -> str:
        """
        요약문 검증 및 강제 수정 (Post-processing v3.8)
    ...
    def build_few_shot_prompt(
        ...
        """
        Few-shot 프롬프트 생성 (v3.8 - 고립 조사 제거)
        ...
        """
        # 프롬프트 버전
        PROMPT_VERSION = "v3.8_isolated_particle_removal"
