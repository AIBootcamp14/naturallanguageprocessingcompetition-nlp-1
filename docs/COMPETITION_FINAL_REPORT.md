...
✅ **Baseline 재현 성공** (47.12점)
✅ **최고 점수 달성** (47.47점, +0.35점)
...
|--------|------|-----------|------|------|
| **Baseline** | 공식 코드 재현 | 47.12 | - | ✅ 성공 |
| **Phase 1: LP=0.5** | Length Penalty 최적화 | **47.47** | **+0.35** | ✅ **최고** |
| Phase 1: LP=0.3 | LP 추가 실험 | 47.15 | +0.03 | ✅ 성공 |
| Phase 1: LP=0.7 | LP 추가 실험 | 47.22 | +0.10 | ✅ 성공 |
| **Exp #5** | no_repeat_ngram=3 | 47.03 | -0.44 | ❌ 실패 |
| **Exp #6** | Learning Rate 3e-5 | - | - | ⏸️ 보류 |
| **Exp #7-A** | 증강 데이터 (가중치 없음) | 47.41 | -0.06 | ✅ 안정 |
| Exp #7-C | 가중치 max=5.0 | - | - | ⏭️ 스킵 |
...
| Exp #7-C | +0.40 | (스킵) | ⏭️ 사전 실패 예측 |
| Exp #7-F | +0.47 | 46.62 | ❌ 실패 (분포 왜곡) |

**교훈**:
- ✅ Loss Gap +0.15 이상 권장
- ⚠️ Loss Gap 양수 = 필요조건이지 충분조건 아님
- ⚠️ Train 분포 왜곡 시 양수여도 실패 가능
...
|----------------|------------|------|------|
| 1.0 | 47.12 | Baseline | - |
| **0.5** | **47.47** | **+0.35** 🏆 | Sweet spot |
| 0.3 | 47.15 | +0.03 | 과도 (너무 긴 요약) |
| 0.7 | 47.22 | +0.10 | 준수 |
...
47.5 |    /47.47
     |   /
47.0 |__/___________📊______________
     | 47.12      47.41
     |                             \
46.5 |                              \
     |                               ❌46.62
46.0 |________________________________
