...
- ✅ **7가지 고급 기능** (증강, K-Fold, 앙상블, Solar API, Optuna, 프롬프트 엔지니어링, Instruction Tuning)
...
### 기본 모듈 문서 (6개)
- `00_전체_시스템_개요.md` - 시스템 아키텍처 및 모듈 구조
- `01_Config_시스템.md` - YAML 계층적 병합
- `02_데이터_처리.md` - 전처리 및 Dataset
- `03_모델_로더.md` - HuggingFace 모델 로딩
- `04_평가_시스템.md` - ROUGE 평가
- `05_학습_시스템.md` - Seq2SeqTrainer 래핑
- `06_추론_시스템.md` - 배치 추론 및 제출 파일 생성

### 고급 기능 문서 (7개)
- `07_LLM_파인튜닝_시스템.md` - LoRA/QLoRA, Llama, Qwen
- `08_데이터_증강_시스템.md` - 5가지 증강 방법
- `09_교차_검증_시스템.md` - K-Fold Stratified 분할
- `10_앙상블_시스템.md` - Weighted, Voting 앙상블
- `11_Solar_API_시스템.md` - 토큰 최적화, Few-shot
- `12_Optuna_최적화_시스템.md` - 15개 하이퍼파라미터 탐색
- `13_프롬프트_엔지니어링_시스템.md` - 16개 템플릿, 동적 선택

### 보조 문서 (3개)
- `Logger_통합_가이드.md` - Logger 사용법
- `빠른_시작_가이드.md` - 5분 빠른 시작
- `스크립트_사용법.md` - 8개 스크립트 상세 가이드
- `실행_명령어_총정리.md` - 모든 실행 명령어
...
2. [실행_명령어_총정리.md](./실행_명령어_총정리.md) - 모든 실행 명령어
3. [02_핵심_시스템.md](./02_핵심_시스템.md) - 시스템 아키텍처
4. [04_모델_학습_추론.md](./04_모델_학습_추론.md) - 모델 학습 및 추론
...
### 문서 수정 시
1. 개별 문서 수정 (`00_*.md`, `01_Config_*.md`, 등)
2. 통합 문서에 반영 (`01_시작_가이드.md`, `02_핵심_시스템.md`, 등)
3. 이 README.md 업데이트
...
2. [실행_명령어_총정리.md](./실행_명령어_총정리.md) → 문제 해결 섹션
3. 로그 파일 확인: `logs/YYYYMMDD/`
