#!/usr/bin/env python3
"""
Exp #3-v2 Test Set 추론 스크립트

checkpoint-1000 (Epoch 4, Best eval_loss)을 사용하여
Test set에 대한 요약문을 생성합니다.

사용 방법:
    python infer_test_exp3_v2.py

출력:
    - prediction/exp3_v2_output.csv
"""
...
def main():
    print("=" * 80)
    print("🚀 Exp #3-v2 Test Set 추론 (checkpoint-1000)")
    print("=" * 80)
    ...
    # 2. Checkpoint 경로 설정 (BEST checkpoint)
    checkpoint_path = '/Competition/NLP/naturallanguageprocessingcompetition-nlp-1/submission/checkpoint-1000'
    print(f"\n✅ Checkpoint: {checkpoint_path}")
    print(f"   Epoch: 4 (Best eval_loss: 0.5152)")
    ...
    # 저장 경로 설정
    save_path = './prediction/exp3_v2_output.csv'
    ...
    print(f"2. 대회 플랫폼 제출")
    print(f"3. 점수 기록 (기대: checkpoint-1000이 더 나을 가능성)")
    print("=" * 80)
