...
- **목표**: +0.5~1.2점
- **방법**:
  - 공백 정규화 (`re.sub(r'\s+', ' ', text)`)
  - 중복 문장 제거
  - `scripts/inference_utils.py` 수정
- **예상 점수**: 47.5~48.2
- **소요 시간**: 1시간
- **리스크**: ✅ Low (부작용 없음, 롤백 쉬움)
- **우선순위**: 🔥 즉시 실행
- **Status**: 📋 Planned (2025-10-13)
- **비고**: Agent 4 권장, ROUGE 최적화 기법

#### Exp #3: Learning Rate 2e-5
- **목표**: +1~2점
- **방법**: `config['training']['learning_rate'] = 2e-5` (1e-5 → 2e-5)
- **예상 점수**: 48.5~49.5
- **소요 시간**: 30분 (학습 20분)
- **리스크**: ✅ Low (공식 권장 범위)
- **우선순위**: Day 2
- **Status**: 📋 Planned (2025-10-13)
- **비고**: Agent 2 최우선 권장, BART는 LR에 매우 민감

#### Exp #4: Learning Rate 3e-5
- **목표**: +1~2점
- **방법**: `config['training']['learning_rate'] = 3e-5`
- **예상 점수**: 49.5~50.5
- **소요 시간**: 30분
- **리스크**: ✅ Low
- **우선순위**: Day 3 (Exp #3 성공 시)
- **Status**: 📋 Planned (2025-10-13)
- **조건부**: Exp #3에서 +1점 이상 달성 시 진행

#### Exp #5: Learning Rate 5e-5
- **목표**: +2~3점
- **방법**: `config['training']['learning_rate'] = 5e-5`
- **예상 점수**: 50~52
- **소요 시간**: 30분
- **리스크**: ⚠️ Medium (불안정 가능성)
- **우선순위**: Day 4 (Exp #4 성공 시, 신중하게)
- **Status**: 📋 Planned (2025-10-13)
- **주의**: 높은 LR, 학습 불안정 가능
